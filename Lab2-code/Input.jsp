...
<script src="<s:url value="/public/js/bootstrap.min.js" />"></script>
  ...
  <body>
	...
	<div class="row">
		...
		<form id="Insert"  class="form-horizontal" name="Insert" action="/firstapp/Insert.action" method="post">
  <fieldset>
    <legend>请输入图书信息</legend>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">ISBN:</label>
      <div class="col-lg-10">
        <input type="text" name="ISBN" value="" id="Action_name" placeholder="ISBN">
      </div>
    </div>
     <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Title:</label>
      <div class="col-lg-10">
        <input type="text" name="Title" value="" id="Action_name" placeholder="Title">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="Publisher" value="" id="Action_name" placeholder="Publisher">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="PublishDate" value="" id="Action_name" placeholder="PublishDate">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="Price" value="" id="Action_name" placeholder="Price">
      </div>
    </div>
